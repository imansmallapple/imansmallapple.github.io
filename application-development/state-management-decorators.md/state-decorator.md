...
<div style="text-align:center">
    <img src='/application-development/image-basic/image16.png' width="30%">
    <img src='/application-development/image-basic/image17.png' width="30%">
</div>
...
```
<div style="text-align:center">
    <img src='/application-development/image-basic/v5.gif' >
</div>

### Additional Information
For more detailed information, click the link [here](https://github.com/eclipse-oniro-mirrors/docs/blob/OpenHarmony-4.1-Release/en/application-dev/quick-start/arkts-state.md)
